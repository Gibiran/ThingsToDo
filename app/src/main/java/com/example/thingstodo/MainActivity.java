...
public class MainActivity extends AppCompatActivity {
    ...
    NoScrollLV taskListToday, taskListTomorrow, taskListUpcoming;
    ...
    public void openAddModifyTask(View view) {
        startActivity(new Intent(this, TambahEditTask.class));
    }
    ...
    public void loadListView(NoScrollLV listView, final ArrayList<HashMap<String, String>> dataList) {
        ListTaskAdapter adapter = new ListTaskAdapter(this, dataList, mydb);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                Intent i = new Intent(MainActivity.this, TambahEditTask.class);
